...
Milestone M0 is complete. The Mac and Windows checkpoints and published cross-platform CI pass. A later explicit owner request on 2026-07-17 activated M1 for macOS; this file remains the historical M0 record.
...
- Objective and current state: M0 is complete on macOS and Windows with published CI evidence; M1 was subsequently activated for macOS.
...
- Completion rule: satisfied on 2026-07-17. The separate M1 request was received later that day.
