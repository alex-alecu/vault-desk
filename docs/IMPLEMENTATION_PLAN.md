...
This document is the milestone-by-milestone plan for the first Vault Desk implementation phase. M0 completed on 2026-07-17. The M1 shared implementation, macOS certification, and Windows microVM certification completed by 2026-07-18; M1 remains active only for the Windows current-user named-pipe permission gate. M2 remains unauthorized.
