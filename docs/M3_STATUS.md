...
- The Tauri and React desktop provides native folder and file selection, global and folder sessions, newest-five pagination, Show more, drafts, attachments, conversation restoration, safe CommonMark assistant responses, activity details, generated artifacts, cancellation, keyboard focus, reduced motion, and responsive scaling.
